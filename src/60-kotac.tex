...
\begin{array}{l@{\hspace{1mm}}c@{\hspace{1mm}}l@{\hspace{-8mm}}r}
        ...
        \aexp & \BNFcce & \xname \, \BNFmid \, \anyvalue \, \BNFmid \, \aexp(\overline{\aexp}) \, \BNFmid \, \repK(\aexp)\{ (\xname) \ftoSym \aexp \} \, \BNFmid \, \nbrK\{\aexp\} \, \BNFmid \,
                                                                                                                                                                                                        &   {\footnotesize \mbox{aggregate expression}} \\
        && \shareK(\aexp)\{(\xname) \ftoSym \aexp \} \\[3pt]
                \anyvalue & \BNFcce &  \lvalue \; \BNFmid \; \fvalue
                &{ \mbox{\footnotesize value}}
                \\[3pt]
                \lvalue & \BNFcce &  \alvalue \; \BNFmid \; \slvalue
                &{ \mbox{\footnotesize local value}}
                \\[3pt]
              \alvalue & \BNFcce &  \dcOf{\dc}{\overline\lvalue} \; \BNFmid \; \afunvalue
                &{ \mbox{\footnotesize aggregate local value}}
                \\[3pt]
...
\begin{array}{c}
  ...
  \funvalue=\vrootOf{\vtree} \mbox{is aggregate and not a built-in} \qquad
\\
...
\atype & \BNFcce & \atOf{\type}{\tann} &   {\footnotesize \mbox{annotated type}} \\
%
\type & \BNFcce &  \tvar  \; \BNFmid \;  \builtintype \; \BNFmid \;  (\overline\atype) \rightarrow \atype        &   {\footnotesize \mbox{type}} \\
%
\tann & \BNFcce &  \aann \; \BNFmid \;  \sann &   {\footnotesize \mbox{type annotation}} \\
%
\typescheme & \BNFcce &  \forall\overline{\tvar}.\atype      &   {\footnotesize \mbox{type scheme}} \\
%
...
\textbf{Expression typing:} 
  \hfill
  \boxed{\expTypJud{\TStypEnv}{\TtypEnv}{\e}{\atype}}
\vspace{0.1cm}
  \\
\begin{array}{c}
{
\surfaceTyping{T-ANN}{ \quad
\expTypJud{\TStypEnv}{\TtypEnv}{\e}{\atOf{\type}{\sann}}
}{
\expTypJud{\TStypEnv}{\TtypEnv}{\e}{\atOf{\type}{\aann}} }
}
\qquad
\skiptransition
%
