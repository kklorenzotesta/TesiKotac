...
\begin{array}{c}
  ...
  \qquad \vtree'=\builtinop{\abname}{\correction{\deviceId}}{\piBof{\abname}{\Trees},\senstate}(\vrootOf{\overline{\vtree}})
\end{array}
 }{
\bsopsem{\deviceId}{\Trees}{\senstate}{\e(\overline{\e})}{\mkvt{\vrootOf{\vtree'}}{\vtree,\overline{\vtree},\vtree'}}
}
%
\skiptransition\\[-6pt]
%
...
\begin{array}{c}
  ...
  \afunvalue=\vrootOf{\vtree} \mbox{ not a built-in} \qquad
\\
  \bsopsem{\deviceId}{\piBof{\afunvalue}{\Trees}}{\senstate}{\applySubstitution{\body{\afunvalue}}{\substitution{\args{\afunvalue}}{\vrootOf{\overline{\vtree}}}}}{\vtree'}
\end{array}
}{
\bsopsem{\deviceId}{\Trees}{\senstate}{\e(\overline{\e})}{\mkvt{\vrootOf{\vtree'}}{\vtree,\overline{\vtree},\vtree'}}
}
...
\begin{array}{c}
  ...
  \qquad \mkvt{\sanyvalue}{} = \builtinop{\sbname}{\correction{\deviceId}}{\emptyseq,\senstate}(\vrootOf{\overline{\vtree}})
\end{array}
 }{
\bsopsem{\deviceId}{\Trees}{\senstate}{\e(\overline{\e})}{\mkvt{\anyvalue}{\vtree,\overline{\vtree}, \mkvt{\sanyvalue}{}}}
}
%
\skiptransition\\[-6pt]
%
...
\begin{array}{c}
  \bsopsem{\deviceId}{\piIofOv{\Trees}}{\senstate}{\overline{\e},\e}{\overline{\vtree},\vtree} \qquad 
  \sfunvalue=\vrootOf{\vtree} \mbox{ not a built-in} \qquad
\\
  \bsopsem{\deviceId}{\emptyseq}{\senstate}{\applySubstitution{\body{\sfunvalue}}{\substitution{\args{\sfunvalue}}{\vrootOf{\overline{\vtree}}}}}{ \mkvt{\sanyvalue}{} }
\end{array}
 }{
\bsopsem{\deviceId}{\Trees}{\senstate}{\e(\overline{\e})}{\mkvt{\sanyvalue}{\vtree,\overline{\vtree}, \mkvt{\sanyvalue}{}}}
}
%
\skiptransition\\[-5pt]
\surfaceTyping{E-NBR}{
