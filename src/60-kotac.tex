...
\section{\FKotac semantics}

\begin{figure}[t]
\centering
\centerline{$
\begin{array}{l@{\hspace{1mm}}c@{\hspace{1mm}}l@{\hspace{-8mm}}r}
        \PROGRAM & \BNFcce & \overline{\SFUNCTION} \; \overline {\AFUNCTION} \; \aexp
        ...
        \aexp & \BNFcce & \xname \, \BNFmid \, \anyvalue \, \BNFmid \, \aexp(\overline{\aexp}) \, \BNFmid \, \repK(\aexp)\{ (\xname) \ftoSym \aexp \} \, \BNFmid \, \nbrK\{\aexp\} \, \BNFmid \,
                                                                                                                                                                                                        &   {\footnotesize \mbox{aligned expression}} \\
        && \shareK(\aexp)\{(\xname) \ftoSym \aexp \} \\[3pt]
        \sexp & \BNFcce & \xname \, \BNFmid \, \slvalue \, \BNFmid \, \sexp(\overline{\sexp})
                                                                                                                                                                                                        &   {\footnotesize \mbox{standard expression}} \\[3pt]
        \hline \\[-6pt]
                \anyvalue & \BNFcce &  \alvalue \; \BNFmid \; \slvalue \; \BNFmid \; \fvalue
                &{ \mbox{\footnotesize value}}
                \\[3pt]
              \alvalue & \BNFcce &  \dcOf{\dc}{\overline\alvalue} \; \BNFmid \; \afunvalue
                &{ \mbox{\footnotesize aligned local value}}
                \\[3pt]
              \slvalue & \BNFcce &  \dcOf{\dc}{\overline\slvalue} \; \BNFmid \; \sfunvalue
                &{ \mbox{\footnotesize standard local value}}
                \\[3pt]
...
In order to formalize the semantic of \Kotac{} a subset of it has been considered called \textit{Featherweight \Kotac{} (\FKotac{})}. The syntax of \FKotac is shown in figure \ref{fig:fkotacsyntax}, it focus on the aggregate constructs ignoring the Kotlin specific features. Unlike \FSCAFI, which considers only aggregate functions (which require alignment), in \FKotac has been considered also standard function, i.e. functions that don't require alignment and don't allow to call aggregate functions and aggregate constructs in their body. 
...
\begin{array}{c}
  ...
  \qquad \abname = \vrootOf{\vtree}
  \qquad \anyvalue=\builtinop{\abname}{\correction{\deviceId}}{\piBof{\abname}{\Trees},\senstate}(\vrootOf{\overline{\vtree}})
\end{array}
 }{
...
\skiptransition\\[-6pt]
\surfaceTyping{E-BS-APP}{  \quad
\begin{array}{c}
  \bsopsem{\deviceId}{\piIofOv{\Trees}}{\senstate}{\overline{\e},\e}{\overline{\vtree},\vtree}
  \qquad \sbname = \vrootOf{\vtree}
  \qquad \anyvalue=\builtinop{\sbname}{\correction{\deviceId}}{\senstate}(\vrootOf{\overline{\vtree}})
\end{array}
 }{
\bsopsem{\deviceId}{\Trees}{\senstate}{\e(\overline{\e})}{\mkvt{\anyvalue}{\overline{\vtree},\vtree}}
}
...
\skiptransition\\[-6pt]
%
\surfaceTyping{E-DS-APP}{ \quad
\begin{array}{c}
  \bsopsem{\deviceId}{\piIofOv{\Trees}}{\senstate}{\overline{\e},\e}{\overline{\vtree},\vtree} \qquad 
  \funvalue=\vrootOf{\vtree} \mbox{is standard and not a built-in} \qquad
\\
