...
\begin{array}{l@{\hspace{1mm}}c@{\hspace{1mm}}l@{\hspace{-8mm}}r}
        ...
        \AFUNCTION & \BNFcce &  \funK \; \afname (\overline{\xname}) \; \{ \alignK(\afname){\{\e\}} \}
                                                                                                                                                                                                        &   {\footnotesize \mbox{aligned function declaration}} \\[3pt]
        \SFUNCTION & \BNFcce &  \funK \; \sfname (\overline{\xname}) \; \{ \e \}
                                                                                                                                                                                                        &   {\footnotesize \mbox{standard function declaration}} \\[3pt]
        \e & \BNFcce & \xname \, \BNFmid \, \anyvalue \, \BNFmid \, \e(\overline{\e}) \, \BNFmid \, \sfname(\overline{\e}) \, \BNFmid \, \repK(\e)\{ (\xname) \ftoSym \e \} \, \BNFmid \, \nbrK\{\e\} \, \BNFmid \,
                                                                                                                                                                                                        &   {\footnotesize \mbox{expression}} \\
        && \shareK(\e)\{(\xname) \ftoSym \e \} \\[3pt]
        \hline \\[-6pt]
        ...
        \afunvalue & \BNFcce & \bname \; \BNFmid \; \afname \; \BNFmid \; (\overline{\xname}) \; \toSym{\name}{\{\alignK(\name)\{\e\}\}}
