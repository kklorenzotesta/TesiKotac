...
\end{array}$}
 ...
 \caption{Small-step operational semantics for network evolution.} \label{fig:fscafinetworkSemantics}
\end{figure}

Figure \ref{fig:fscafinetworkSemantics} defines the operational semantics of whole networks. 
